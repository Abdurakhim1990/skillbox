...
const ::uint32_t
    TableStruct_company_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::Company, _impl_.date_),
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.date_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.date_)) + sizeof(_impl_.activity_));
  }
...
const ::_pbi::TcParseTable<3, 5, 0, 37, 2> Company::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Company, _impl_.date_), 3>(),
     {8, 3, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.date_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Company, _impl_.activity_), 4>(),
     {40, 4, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.activity_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // required int32 date = 1;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.date_), _Internal::kHasBitsOffset + 3, 0,
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional bool activity = 5;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.activity_), _Internal::kHasBitsOffset + 4, 0,
...
::uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        5, this->_internal_activity(), target);
  }
...
void Company::InternalSwap(Company* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.activity_)
      + sizeof(Company::_impl_.activity_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.date_)>(
